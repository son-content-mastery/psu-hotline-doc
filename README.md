...
- Admin-managed optional provider directory with source status, reference price ranges, and a mandatory non-endorsement disclaimer; seeded entries are fictional.
